...
[phase_1, Z1, M_1, Rtrans_1] = calculatePhaseAndTransmissions(frequency_1, n_KK1, g1, S01, S10, c, Lc, Np);
[phase_2, Z2, M_2, Rtrans_2] = calculatePhaseAndTransmissions(frequency_2, n_KK2, g2, S02, S20, c, Lc, Np);
...
title('Transmission Phase of the Fabry-Perot cavity'); 
...
function [phase_1, Z1, M_1, Rtrans_1] = calculatePhaseAndTransmissions(frequency_1, n_KK1, g1, S01, S10, c, Lc, Np)
